...
if(request.getParameter("submit")!=null)
{
         ...
         ResultSet query = st.executeQuery("select adpwd from admin where ademail='"+email+"'");
         while(query.next())
         {
    ...
    response.sendRedirect("adminlogin");
      ...
      out.write("                <h2 style=\"background-color: whitesmoke\">Forget password</h2>\n");
      out.write("                <table>\n");
      out.write("                    <img src=\"images/admin.png\" width=\"100\" height=\"100\" class=\"d-inline-block \" alt=\"logo2\">\n");
      out.write("                    <form action=\"Forgetpwd\" method=\"post\">\n");
